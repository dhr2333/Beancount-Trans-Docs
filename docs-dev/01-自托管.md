...
modify_time: 2026-09-15T13:40:00
authors: dhr2333
status: Published
channels:
...
平台内置 MCP 服务，把当前用户的账本以**只读**方式提供给 Claude Code、Cursor 等支持 MCP 的 AI 客户端。本节只讲部署与配置，客户端侧的操作步骤与可用能力见 [接入 AI 客户端](https://trans.dhr2333.cn/docs/%E6%93%8D%E4%BD%9C%E6%8C%87%E5%8D%97/connect-ai-client)。
...
平台侧配置完成后，在客户端中把端点地址填为 `http://your-domain.com:38001/mcp`，并附上访问令牌即可。令牌的两种取得方式（个人访问令牌 / OAuth 2.1）与完整配置步骤见 [接入 AI 客户端](https://trans.dhr2333.cn/docs/%E6%93%8D%E4%BD%9C%E6%8C%87%E5%8D%97/connect-ai-client)。
